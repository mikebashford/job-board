...
const JobDetailPage: React.FC = () => {
  ...
  const handleSaveClick = () => {
    ...
    // TODO: Integrate with backend/user state
  }

  const handleReportClick = () => {
    // Placeholder: In production, open a modal or send a report
    ...
    <main className="max-w-3xl mx-auto bg-white rounded-lg shadow p-8 mt-8 flex flex-col gap-4">
      ...
      <div className="flex gap-4 mb-4">
        ...
        <button
          ...
          className={`px-5 py-2 rounded font-semibold shadow focus:outline-none focus:ring-2 focus:ring-blue-400 ${isSaved ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700 hover:bg-blue-200'}`}
