...
import JoobleJobsList from './JoobleJobsList'
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-200">
      <nav className="w-full flex justify-center gap-8 py-4">
        ...
        <Link to="/jooble-jobs" className="text-blue-700 font-bold hover:underline">
          Jooble Jobs
        </Link>
      </nav>
      <Routes>
            ...
            <>
              ...
              <div className="bg-white rounded-xl shadow-md p-8 flex flex-col items-center mb-6">
                ...
                <p className="text-gray-600">
                  Edit <code className="bg-gray-100 px-1 rounded">src/App.tsx</code> and save to
                  test HMR
                </p>
              </div>
